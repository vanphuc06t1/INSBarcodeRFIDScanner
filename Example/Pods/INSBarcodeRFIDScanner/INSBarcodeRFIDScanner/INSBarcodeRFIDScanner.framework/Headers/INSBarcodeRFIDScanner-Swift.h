...
- (void)startRFIDScanningAnimation;
- (void)stopRFIDScanningAnimation;
- (void)shouldHideFocusView:(BOOL)shouldHide;
- (void)updateRecordButton:(BOOL)isScanFinished;
- (void)updateFinishedScanLayout:(BOOL)isScanFinished;
- (void)updateBarcodeValue:(NSString * _Nonnull)value;
- (void)updateRFIDValue:(NSString * _Nonnull)value;
- (void)updateMatchNotMatchLayout:(BOOL)isMatch;
- (void)resetMatchNotMatchLayout;
- (void)shouldEnableResetButton:(BOOL)shouldEnable;
- (void)captureResult:(ZXCapture * _Null_unspecified)capture result:(ZXResult * _Null_unspecified)result;
...
@protocol INSBarcodeRFIDReaderDelegate
- (void)scanner:(INSBarcodeRFIDReader * _Nonnull)scanner didRecordResult:(UIImage * _Nonnull)didRecordResult isMatch:(BOOL)isMatch;
- (void)scannerDidCancel:(INSBarcodeRFIDReader * _Nonnull)scanner;
@end
...
- (void)radioStateChangedOperationInProgress:(BOOL)in_progress aType:(int32_t)operation_type;
- (BOOL)deviceListHasBeenUpdated SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface UIColor (SWIFT_EXTENSION(INSBarcodeRFIDScanner))
@end


@interface UIFont (SWIFT_EXTENSION(INSBarcodeRFIDScanner))
@end


@interface UIImage (SWIFT_EXTENSION(INSBarcodeRFIDScanner))
- (UIImage * _Nullable)loadImageFromPath:(NSString * _Nonnull)path SWIFT_WARN_UNUSED_RESULT;
