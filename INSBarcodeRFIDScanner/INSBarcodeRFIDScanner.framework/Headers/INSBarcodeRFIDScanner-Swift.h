...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="INSBarcodeRFIDScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("RFIDValidation")
@interface RFIDValidation : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
